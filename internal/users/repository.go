...
type Repository interface {
	...
	GetByID(id uuid.UUID, loadEvents bool, loadParticipations bool) (models.User, error)
...
func (r *repository) GetByID(id uuid.UUID, loadEvents bool, loadParticipations bool) (models.User, error) {
